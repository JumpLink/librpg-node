...
### BEGIN INIT INFO
# Provides:          node_hmworl_init
# Required-Start:    $remote_fs $named $syslog
# Required-Stop:     $remote_fs $named $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: node.js hmworld http server
# Description:       ex : proxy server is a node.js http server listening on
#                    port 3001. It balances
#                    http requests between the main nodejs server 
#                    (nodejs.mydomain.com:3001), the static file-server 
...
[ "\$UID" = "0" ] && LOCAL_VAR_RUN=/var/run # in case this script is run by root, override user setting
THIS_ARG=$0
